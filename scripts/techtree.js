...
//liquids
newNode(Liquids.oil, creotite, req, Seq.with(new Objectives.Produce(creotite)) );
newNode(Liquids.cryofluid, ledonite, req, Seq.with(new Objectives.Produce(ledonite)) );
