...
newNode(SectorPresets.planetaryTerminal, sectors.creotitePowerStation, null, Seq.with(new SectorComplete(SectorPresets.desolateRift), new SectorComplete(SectorPresets.navalFortress)));
