...
newNode(SectorPresets.planetaryTerminal, sectors.creotitePowerStation, null, Seq.with(new Objectives.SectorComplete(SectorPresets.desolateRift), new Objectives.SectorComplete(SectorPresets.navalFortress)));
