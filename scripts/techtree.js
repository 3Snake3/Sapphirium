...
newNode(SectorPresets.planetaryTerminal, sectors.creotitePowerStation, 0, Seq.with(new Objectives.SectorComplete(SectorPresets.desolateRift), new Objectives.SectorComplete(SectorPresets.navalFortress)));
