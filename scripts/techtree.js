...
//liquids
//this is not work, null object reference.
...
newNode(blocks.cryocubeW, blocks.cryocubeWT, ItemStack.with(Items.silicon, 3500, creostone, 1200), Seq.with(new Objectives.Research(Blocks.swarmer)));*/
