                ...
                table.table(this.infoStyle.up, part => {
                    ...
                    if(inputPower > 0) {
                        part.table(cons(row => {
                            ...
                            (StatValues.number(this.recs[i].input.power * 60, StatUnit.powerSecond)).display(row);
                        })).left().row();
                    }
                    ...
                    if(outputPower > 0) {
                        part.table(cons(row => {
                            ...
                            (StatValues.number(this.recs[i].output.power * 60, StatUnit.powerSecond)).display(row);
                        })).left().row();
                    }
                    part.table(cons(row => {
